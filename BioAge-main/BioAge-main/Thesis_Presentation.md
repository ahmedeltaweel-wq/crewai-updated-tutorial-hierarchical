...
| **C-Index (الأساس)** | **0.687** | دقة على البيانات الحيوية |
| **C-Index (المتوقع)** | **0.764*** | *مع بيانات الساعات |
...
| XGBAge | 0.728 | +6.0% |
| **DeepSurv** | **0.687-0.764*** | **+0% إلى +11.2%** |

*ملاحظة: DeepSurv يحقق 0.687 على البيانات الحيوية فقط. الرقم 0.764 **متوقع** مع دمج بيانات الساعات الذكية.*

> DeepSurv يتفوق مع التكامل الكامل!
